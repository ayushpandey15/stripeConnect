...
function registerUser(req,res){
    ...
    let business_name                 = req.body.business_name;           // when Acc type is company
    let business_tax_id               = req.body.business_tax_id;         // when Acc type is company    
    ...
    Promise.coroutine(function*(){
        ...
        console.log("the result is...",stripeKeyResult);
        ...
        return res.status(400).send({status: 400,message:error.message ? error.message : error});
    })
}

function getStripeAccountDetails(req, res){
...
function transferBalence(req, res){
    ...
    Promise.coroutine(function*(){
       ...
       let insertobj={
        ...
        mongoConnection.insertpPaymentLogsPromisfy(insertobj);     
        return ({
            status : 200,
